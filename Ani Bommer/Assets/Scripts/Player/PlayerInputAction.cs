...
public partial class @PlayerInputAction: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerInputAction()
    {
        UnityEngine.Debug.Assert(!m_PlayerController.enabled, "This will cause a leak and performance issues, PlayerInputAction.PlayerController.Disable() has not been called.");
    }
    ...
    public struct PlayerControllerActions
    {
        ...
        public PlayerControllerActions(@PlayerInputAction wrapper) { m_Wrapper = wrapper; }
